...
namespace Controllers
{
    public class HomeController : Controller
    {
        ...
        // Acción para mostrar la página de inicio de sesión o bienvenida
        public ActionResult Index()
        {
            return View(); // Nueva vista "Index" para el login
        }

        // Acción para mostrar la página principal después del inicio de sesión
        ...
        [HttpPost]
        public ActionResult Land(int id)
        {
            try
            {
